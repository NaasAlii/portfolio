...
function GalleryVideoComponent_ng_container_2_source_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const src_r1 = ɵɵnextContext().$implicit;
    ɵɵproperty("src", src_r1 == null ? null : src_r1.url)("type", src_r1.type);
  }
}
function GalleryVideoComponent_ng_container_2_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const src_r1 = ɵɵnextContext().$implicit;
    ɵɵproperty("src", src_r1 == null ? null : src_r1.url);
  }
}
function GalleryVideoComponent_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const noType_r2 = ɵɵreference(3);
    ɵɵadvance();
    ɵɵproperty("ngIf", src_r1 == null ? null : src_r1.type)("ngIfElse", noType_r2);
  }
}
...
function GallerySliderComponent_gallery_item_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("activeIndexChange", function GallerySliderComponent_gallery_item_5_Template_gallery_item_activeIndexChange_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onActiveIndexChange($event));
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("type", item_r4.type)("config", ctx_r1.config)("data", item_r4.data)("currIndex", ctx_r1.state.currIndex)("index", i_r3)("count", ctx_r1.state.items.length)("itemIntersectionObserverDisabled", ctx_r1.isScrolling || ctx_r1.isSliding || ctx_r1.isResizing)("adapter", ctx_r1.adapter);
...
function GalleryThumbsComponent_gallery_thumb_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function GalleryThumbsComponent_gallery_thumb_5_Template_gallery_thumb_click_0_listener() {
      const i_r2 = ɵɵrestoreView(_r1).index;
      const ctx_r2 = ɵɵnextContext();
      return ɵɵresetView(ctx_r2.config.disableThumbs ? null : ctx_r2.thumbClick.emit(i_r2));
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function GalleryVideoComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ɵɵproperty("disableRemotePlayback", ctx.disableRemotePlayback)("controls", ctx.controls)("loop", ctx.loop)("poster", ctx.poster);
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      viewQuery: function GallerySliderComponent_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuery(_c2, 7)(GalleryItemComponent, 5);
        }
        if (rf & 2) {
          let _t;
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      viewQuery: function GalleryThumbsComponent_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuery(_c2, 7)(GalleryThumbComponent, 5);
        }
        if (rf & 2) {
          let _t;
          ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.sliderEl = _t.first);
      ...
      template: function GalleryThumbsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵlistener("thumbResizeObserver", function GalleryThumbsComponent_Template_div_thumbResizeObserver_0_listener() {
            return ctx.scrollToIndex(ctx.state.currIndex, "auto");
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      contentQueries: function GalleryComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ɵɵcontentQuery(dirIndex, GalleryItemDef, 5)(dirIndex, GalleryImageDef, 5)(dirIndex, GalleryThumbDef, 5)(dirIndex, GalleryBoxDef, 5);
        }
        if (rf & 2) {
          let _t;
...
//# sourceMappingURL=chunk-F5OQLTN2.js.map
